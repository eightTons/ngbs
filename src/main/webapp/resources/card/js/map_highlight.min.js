(function(G) {
    ...
    L = function(Q, P) {
        var O = G(Q);
        return G.extend({},
            P, G.metadata ? O.metadata() : false, O.data("maphilight"))
    };
    A = function(O) {
        if (!O.complete) {
            return false
    ...
    G.fn.maphilight = function(O) {
        ...
        return this.each(function() {
            ...
            Y = G.extend({},
                O, G.metadata ? U.metadata() : false, U.data("maphilight"));
            ...
            G(Q).trigger("alwaysOn.maphilight").find("area[coords]").bind("mouseover.maphilight", X).bind("mouseout.maphilight",
                function(Z) {
                    N(T)
                });
            U.before(T);
